;;; 
;;; Square the input, output the answer and repeat.  Input of zero ends the
...
LOOP    LDA RESULT    ; Load the RESULT
        ...
        BRZ ENDLOOP   ; If zero (VALUE has been added to RESULT by VALUE
                      ; times), branch to ENDLOOP
